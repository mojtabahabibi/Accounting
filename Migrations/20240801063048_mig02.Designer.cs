...
namespace EcoBar.Accounting.Migrations
{
    ...
    [Migration("20240801063048_mig02")]
    partial class mig02
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoBar.Accounting.Data.Entities.Company", b =>
                {
                    ...
                    b.Property<long?>("AccountUserId1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EcoBar.Accounting.Data.Entities.InvoiceItem", b =>
                {
                    b.HasOne("EcoBar.Accounting.Data.Entities.Invoice", "Invoices")
                        .WithMany("InvoiceItems")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcoBar.Accounting.Data.Entities.Item", "Items")
                        .WithMany()
